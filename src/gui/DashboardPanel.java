...
public class DashboardPanel extends JPanel {
    ...
    private JPanel createChartPanel() {
        ...
        chartPanel.setBorder(new TitledBorder(BorderFactory.createLineBorder(new Color(52, 152, 219), 2), "Biểu đồ doanh thu"));
    ...
    public void updateDashboardData() {
        try {
            ...
            double dailyRevenue = hoaDonDAO.tinhTongDoanhThu(todayFormatted + " 00:00:00", todayFormatted + " 23:59:59");
