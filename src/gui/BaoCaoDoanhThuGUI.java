...
public class BaoCaoDoanhThuGUI extends JPanel {
    ...
    private void tinhToanChenhLech() {
        ...
        try {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(this, "Có lỗi khi xử lý doanh thu dự kiến. Vui lòng kiểm tra định dạng!",
    ...
    private void inBaoCao() {
        ...
        try {
            ...
            String thoiGianBatDau = ((JSpinner.DateEditor) spnThoiGianBatDau.getEditor()).getFormat()
                    .format(spnThoiGianBatDau.getValue());
            String thoiGianKetThuc = ((JSpinner.DateEditor) spnThoiGianKetThuc.getEditor()).getFormat()
                    .format(spnThoiGianKetThuc.getValue());
