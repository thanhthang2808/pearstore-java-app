...
public class BaoCaoDoanhThuGUI extends JPanel {
    ...
    public BaoCaoDoanhThuGUI(String tenNhanVien) {
        ...
        editorBatDau.getTextField().setFont(new Font("Segoe UI", Font.PLAIN, 22)); 
        gbc.gridx = 0;
        gbc.gridy = 0;
...
add(inputPanel, BorderLayout.CENTER);
    ...
    private void addDateChangeListener() {
        ChangeListener listener = e -> tinhToanDoanhThu(); 
        spnThoiGianBatDau.addChangeListener(listener); 
        spnThoiGianKetThuc.addChangeListener(listener); 
    }
