...
public class QuanLyNhanVienGUI extends JPanel implements ActionListener {
    ...
    public QuanLyNhanVienGUI() {
        ...
        // Table
        tableModel = new DefaultTableModel(new Object[]{"Mã NV", "Tên NV", "Ngày sinh", "Giới tính", "Email", "SĐT", "Chức vụ"}, 0);
    ...
    private void timTheoMa(String maNV) {
        ...
        JOptionPane.showMessageDialog(this, "Không tìm thấy nhân viên có mã: " + maNV, "Lỗi", JOptionPane.ERROR_MESSAGE);
    }
